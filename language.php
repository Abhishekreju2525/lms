			...
			<div class="col-lg-4">
				<div class="card">
					<div class="card-body">
						...
						<a href="deletelanguage.php?id=<?php echo $qq['languageId']; ?>" class="card-link">
							<button class=" btn btn-danger">Delete</button>
						</a>
						<a href= "updatelanguage.php?id=<?php echo $qq['languageId']; ?>" class="card-link">
							Update
						</a>
					</div>
